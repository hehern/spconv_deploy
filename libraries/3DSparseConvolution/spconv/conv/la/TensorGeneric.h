...
struct TensorGeneric {
  ...
  TV_HOST_DEVICE_INLINE  TensorGeneric(std::array<int32_t, 4> const& strides) : strides(strides)  {
    
  }
  TV_HOST_DEVICE_INLINE static TensorGeneric from_shape(const std::array<int, 5> & shape)   {
  ...
  TV_HOST_DEVICE_INLINE int64_t operator()(const std::array<int, 5> & indexes)  const {
  ...
  TV_HOST_DEVICE_INLINE int64_t operator()(const std::array<int64_t, 5> & indexes)  const {
  ...
  TV_HOST_DEVICE_INLINE std::array<int, 5> inverse(int64_t index)  const {
  ...
  TV_HOST_DEVICE_INLINE void inverse(int64_t index, std::array<int, 5>& out)  const {
